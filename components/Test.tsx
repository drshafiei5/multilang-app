    ...
    return (
        <div className="flex flex-row justify-center min-h-screen pt-4 bg-gray-100 min-w-screen">
            <div className="flex-none p-2">
                <button onClick={() => { }} className="flex flex-row justify-between w-48 px-2 py-2 text-gray-700 bg-white border-2 border-white rounded-md shadow focus:outline-none focus:border-blue-600">
